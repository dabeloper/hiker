...
;(function ($) {
        ...
        if (!config.mixing) {
          ...
          if ($.isArray(args)) {
            var sortby = args[0],
              order = args[1]
            $(
              config.sortSelector + '[data-sort="' + args[0] + '"][data-order="' + args[1] + '"]'
            ).addClass('active')
          } else {
  ...
  function goMix(filter, sortby, order, $cont, config) {
    ...
    if ($show.length) {
      ...
      for (var j = 0; j < 2; j++) {
        var c = j == 0 ? (c = config.prefix) : ''
        toShowCSS[c + 'transform'] =
          config.scale + ' ' + config.rotateX + ' ' + config.rotateY + ' ' + config.rotateZ
        toShowCSS[c + 'filter'] = config.blur + ' ' + config.grayscale
      }
      ...
      var delay = setTimeout(function () {
        ...
        $toshow.each(function () {
          ...
          $(this)
            .css('-webkit-transition', 'all ' + speed + 'ms ' + config.easingFallback)
            .css(toShowCSS)
        })
        ...
        var toHideCSS = {}
        for (var j = 0; j < 2; j++) {
          var b = j == 0 ? (b = config.prefix) : ''
          toHideCSS[b + 'transition'] =
            'all ' +
            speed +
            'ms ' +
            config.easing +
            ...
            speed +
            'ms linear'
          toHideCSS[b + 'transform'] =
            config.scale + ' ' + config.rotateX + ' ' + config.rotateY + ' ' + config.rotateZ
          toHideCSS[b + 'filter'] = config.blur + ' ' + config.grayscale
